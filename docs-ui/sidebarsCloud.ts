...
const sidebars: SidebarsConfig = {
  cloudSidebar: [
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        { type: 'doc', id: 'managed-services', label: 'Overview' },
        { type: 'doc', id: 'managed-services-console', label: 'Using the Console' },
        { type: 'doc', id: 'managed-services-plans', label: 'Classes and Plans' },
        {
          type: 'category',
          label: 'PostgreSQL',
          collapsed: true,
          items: [
            ...
            { type: 'doc', id: 'postgresql-credentials', label: 'Credentials and Rotation' },
            { type: 'doc', id: 'postgresql-operations', label: 'Day-2 Operations' },
            { type: 'doc', id: 'postgresql-backup-restore', label: 'Backups and Restore' },
        ...
        { type: 'doc', id: 'managed-services-status-deletion', label: 'Status and Deletion' },
        { type: 'doc', id: 'managed-services-migration', label: 'Migrating from db-manager' },
      ],
    },
    {
      type: 'category',
