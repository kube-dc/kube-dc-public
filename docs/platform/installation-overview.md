...
> Start with actual tested deployment on [Hetzner Bare Metal Servers](installation-hetzner.md).
...
- [Master-Worker Setup (Dedicated Servers)](installation-hetzner.md)
